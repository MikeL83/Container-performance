...
void doAnalysis(const string &cont, int N) {
  ...
  if (cont == "std::list") {
    ...
    processContainer<boost::container::list<int>>(f, N);
    ...
    processContainer<boost::container::slist<int>>(f, N);
    ...
    processContainer<vector<int>>(f, N);
    ...
    processContainer<boost::container::vector<int>>(f, N);
    ...
    processContainer<boost::container::stable_vector<int>>(f, N);
    ...
    processContainer<forward_list<int>>(f, N);
  } else {
...
int main(int argc, char *argv[]) {
  ...
  for (int k = 0; k < runs; k++) {
    ...
    auto f = async(launch::async, doAnalysis, container, number_of_elements);
